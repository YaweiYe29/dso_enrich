...
//	else
    {
        ...
        // select!
        Eigen::Vector3i n = this->select(fh, map_out, currentPotential,
                thFactor);
        ...
        float* map_out, int pot, float thFactor)
{
    ...
    { Vec2f(0, 1.0000), Vec2f(0.3827, 0.9239), Vec2f(0.1951, 0.9808), Vec2f(
            0.9239, 0.3827), Vec2f(0.7071, 0.7071), Vec2f(0.3827, -0.9239),
            Vec2f(0.8315, 0.5556), Vec2f(0.8315, -0.5556), Vec2f(0.5556,
                    -0.8315), Vec2f(0.9808, 0.1951), Vec2f(0.9239, -0.3827),
            Vec2f(0.7071, -0.7071), Vec2f(0.5556, 0.8315), Vec2f(0.9808,
                    -0.1951), Vec2f(1.0000, 0.0000), Vec2f(0.1951, -0.9808) };
                        ...
                        for (int x2 = 0; x2 < mx2; x2 += pot)
                        {
                            ...
                            for (int y1 = 0; y1 < my1; y1 += 1)
                                for (int x1 = 0; x1 < mx1; x1 += 1)
                                {
                                    ...
                                    float pixelTH0 = thsSmoothed[(xf >> 5)
                                            + (yf >> 5) * thsStep];
                                    ...
                                    float ag2 = mapmax2[(int) (xf * 0.25f
                                            + 0.125)
